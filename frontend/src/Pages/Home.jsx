...
function Home() {
  ...
  return (
    <>
      <div className="bg-[url('https://images.pexels.com/photos/277319/pexels-photo-277319.jpeg?cs=srgb&dl=pexels-pixabay-277319.jpg&fm=jpg')] font-inter h-screen md:h-screen bg-cover sm:w-screen">
        <div className="flex flex-col justify-center  text-center justify-items-center  ">
          <span className="text-6xl font-inter p-2 text-white">
